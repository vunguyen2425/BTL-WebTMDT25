...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        try {
            ...
            $nguoigui = 'tungpt03@gmail.com'; // Tài khoản Email
            $matkhau = 'Phanthanhtung030916'; // Mật khẩu Email
            ...
            $to_name = "Phan Thanh Tùng"; // Tên người cần gửi đến
        ...
        // nếu ở trên lỗi thì CATCH sẽ chạy
            ...
            echo 'Hệ thống đang bảo trì! Quay lại sau hoặc liên hệ trực tiếp tại đây<a href="https://www.facebook.com/Alex0172"><span>   </span><i class="fab fa-facebook-square"></i></a>';
        }
    }
    ?>
